...
struct RecordInsulinView: View {
    ...
    func createNewInsulinRecord(_ insulinSetting:InsulinSettingModel?, _ administration:Int){ //인슐린 설정의 기록 추가
        let record: InsulinRecordModel = InsulinRecordModel(dosage: administration, createdAt: date, updatedAt: .now)
...
#Preview {
    ...
    return RecordInsulinView(insulinSetting: InsulinSettingModel(insulinProductName: "dd", actingType: .fast, dosage: 12, records: [], updatedAt: .now))
