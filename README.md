...
2. 인터랙티브 위젯으로 선택한 인슐린의 기록을 추가하는 기능
3. 위젯에서 당일 인슐린 투여시 비활성화
4. lockscreen에서 사용할 수 있는 인터렉티브 위젯 추가
5. 인슐린 투여 기록을 컬렌더 형식으로 보여 줄 수 있도록 할 예정

## 해야할 기능
1. 인슐린 설정하는 뷰
2. 앱 내부에서 투여 버튼을 누를 때 투여량을 바꿀 수 있도록 수정
3. 지효성 인슐린과 속효성 인슐린으로 위젯 구분하도록 수정
4. 속효성 인슐린은 하루에 여러번 누를 수 있게 구현
5. lockScreen Widget 편집시 인슐린 선택할 수 있도록 수정
